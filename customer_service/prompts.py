...
After a file is uploaded, call `upload_transcript(filename=...)` using the **filename** shown by the UI.
...
Tools Available:
- `upload_transcript(filename: str)`: Saves the uploaded meeting transcript.
